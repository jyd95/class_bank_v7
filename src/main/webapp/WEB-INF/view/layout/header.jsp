			...
			<div class="container" style="margin-top: 30px">
				<div class="row">
					<div class="col-sm-4">
						...
						<p>코린이 개발을 위한 뱅크 앱</p>
						<h3>서비스 목록</h3>
						<p>계좌 목록, 생성, 출금, 입금, 이체 처리하기</p>
						<ul class="nav nav-pills flex-column">
							<li class="nav-item"><a class="nav-link" href="/account/list">나의 계좌 목록</a></li>
							<li class="nav-item"><a class="nav-link" href="/account/save">신규 계좌 개설</a></li>
							...
							<li class="nav-item"><a class="nav-link" href="/account/transfer">계좌이체</a></li>
						</ul>
						<hr class="d-sm-none">
					</div>
			<!-- end of header.jsp  -->